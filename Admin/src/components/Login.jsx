        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            ...
            <form action="" onSubmit={onSUbmitHandler}>
                <div className='mb-3 min-w-72' >
                    ...
                    <input onChange={(e)=>setEmail(e.target.value)} value={email} type="email" placeholder='Enter your email Address' required className='rounded-md w-full px-3 py-2 border border-gray-300' />
                </div>
                   <div className='mb-3 min-w-72' >
